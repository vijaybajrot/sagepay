...
return array(
    ...
    'vendorName' => 'protxross', //protxross
    ...
    'siteFqdns' =>
        array(
            'live' => '',
            'test' => 'http://192.168.100.62/sage/public/',
        ),
    ...
    //  Mandatory property, set this value to the Encryption password assigned to you by Sage Pay 	
        'formPassword' =>
            array(
                'test' => 'TPjs72eMz5qBnaTa', //TPjs72eMz5qBnaTa,
                'live' => '',
            ),
    // Mandatory parameters form notifications URLs appended to siteFQDN value
        'formSuccessUrl' => 'test/success',
        'formFailureUrl' => 'test/failure',

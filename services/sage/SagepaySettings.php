...
use Services\Sage\SagepayValid;
use Services\Sage\SagepayValidator;
/**
...
class SagepaySettings
{
     ...
     * @var string
     */
    private $_formSuccessUrl = 'http://192.168.100.62/sage/public/test/success';
     ...
     * @var string
     */
    private $_formFailureUrl = 'http://192.168.100.62/sage/public/test/failure';
    ...
    private $_purchaseUrls = array(
        'test' => array(
            'form' => 'https://test.sagepay.com/gateway/service/vspform-register.vsp',
            'server' => 'https://test.sagepay.com/gateway/service/vspserver-register.vsp',
            'direct' => 'https://test.sagepay.com/gateway/service/vspdirect-register.vsp',
            'direct3d' => 'https://test.sagepay.com/gateway/service/direct3dcallback.vsp',
            'paypal' => 'https://test.sagepay.com/gateway/service/complete.vsp',
        ),
        'live' => array(
            'form' => 'https://live.sagepay.com/gateway/service/vspform-register.vsp',
            'server' => 'https://live.sagepay.com/gateway/service/vspserver-register.vsp',
            'direct' => 'https://live.sagepay.com/gateway/service/vspdirect-register.vsp',
            'direct3d' => 'https://live.sagepay.com/gateway/service/direct3dcallback.vsp',
            'paypal' => 'https://live.sagepay.com/gateway/service/complete.vsp',
        )
    );
    ...
    private $_tokenUrls = array(
        'test' => array(
            'register-server' => 'https://test.sagepay.com/gateway/service/token.vsp',
            'register-direct' => 'https://test.sagepay.com/gateway/service/directtoken.vsp',
            'remove' => 'https://test.sagepay.com/gateway/service/removetoken.vsp',
        ),
        'live' => array(
            'register-server' => 'https://live.sagepay.com/gateway/service/token.vsp',
            'register-direct' => 'https://live.sagepay.com/gateway/service/directtoken.vsp',
            'remove' => 'https://live.sagepay.com/gateway/service/removetoken.vsp',
        )
    );
     ...
     * @var string
     */
    private $_website = "http://192.168.100.62/sage/public";
     ...
     */
    public function __construct(array $config, $loadFileConfig = true)
    {
        if ($loadFileConfig)
        {
    ...
    {
        if (in_array($accountType, array('E', 'C', 'M')))
        {
    ...
    {
        if (in_array($serverProfile, array('LOW', 'NORMAL')))
        {
    ...
    public function __get($property)
    {
        ...
        if(property_exists($this,$privateProp)){
            return $this->{$privateProp};
        } else{
            trigger_error("Calling undefined property , '" . $property . "'", E_USER_WARNING);
        }   
    }

...
class SagepayCommon
{
	 static protected $nonSensitiveRequestDataArray = array(
        "VPSProtocol", 
        "TxType", 
        "Vendor", 
        "VendorTxCode", 
     ...
     static protected $nonSensitiveResponseDataArray = array(
        "VPSProtocol", 
        "Status", 
        "StatusDetail", 
        "VPSTxId"
     ...
     */
    static public function encryptedOrder(SagepayFormApi $request,$requestConfig)
    {
        ...
        $query = array(
            ...
            'Currency' => isset($requestConfig->currency) ? $requestConfig->currency : $settings->getCurrency(),
            'Description' => $basket->items[0]->getDescription(),
     ...
     * @return array
     */
    static private function _populateDeliveryDetails($billingDetails, $deliveryDetails = null)
    {
        $query = array();
        ...
        $query['DeliveryPostCode'] = $deliveryDetails->postcode;
